...
function uploadDenseMatrixToTexture(gl, debug, texture, width, height, data, textureConfig) {
    ...
    var dataForUpload = new Float32Array(width * height * 4);
    dataForUpload.set(data);
    webgl_util.callAndCheck(gl, debug, function () { return gl.texImage2D(gl.TEXTURE_2D, 0, textureConfig.internalFormatPackedFloat, width, height, 0, gl.RGBA, gl.FLOAT, dataForUpload); });
    webgl_util.callAndCheck(gl, debug, function () { return gl.bindTexture(gl.TEXTURE_2D, null); });
}
