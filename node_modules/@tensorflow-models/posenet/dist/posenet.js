    ...
    ***************************************************************************** */
    ...
    var CheckpointLoader = (function () {
            ...
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 3, , 4]);
                            return [4, tf.util.fetch(this.urlPath + MANIFEST_FILE)];
                        case 1:
                            response = _b.sent();
                            if (!response.ok) {
                        ...
                        case 2:
                            _a.checkpointManifest = _b.sent();
                            resolve();
                            return [3, 4];
                        case 3:
                            error_1 = _b.sent();
                            throw new Error(MANIFEST_FILE + " not found at " + this.urlPath + ". " + error_1);
                        case 4: return [2];
                    }
                });
            }); });
        ...
        CheckpointLoader.prototype.getVariable = function (varName) {
            ...
            var variableRequestPromiseMethod = function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var fname, response, values, _a, checkpointTensor, error_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            fname = this.checkpointManifest[varName].filename;
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 4, , 5]);
                            return [4, tf.util.fetch(this.urlPath + fname)];
                        case 2:
                            response = _b.sent();
                            if (!response.ok) {
                        ...
                        case 3:
                            values = new (_a.apply(Float32Array, [void 0, _b.sent()]))();
                            checkpointTensor = tf.tensor(values, this.checkpointManifest[varName].shape, 'float32');
                            resolve(checkpointTensor);
                            return [3, 5];
                        case 4:
                            error_2 = _b.sent();
                            throw new Error("Could not fetch variable " + varName + ": " + error_2);
                        case 5:
                            return [2];
                    }
                });
